        ...
        <div class="wrap pino-admin">
            ...
            <table class="wp-list-table widefat fixed striped">
                ...
                <?php if ( empty( $reservations ) ) : ?>
                    <tr><td colspan="8">Няма резервации.</td></tr>
        ...
        <div class="wrap pino-admin">
            ...
            <div class="pino-two-col">
                <div class="pino-col-form">
                    ...
                    <form method="post">
                        ...
                        <table class="form-table">
                            <tr><th>Име (BG)</th><td><input type="text" name="name_bg" class="regular-text" value="<?php echo esc_attr( $editing['name_bg'] ?? '' ); ?>" required></td></tr>
                            <tr><th>Име (EN)</th><td><input type="text" name="name_en" class="regular-text" value="<?php echo esc_attr( $editing['name_en'] ?? '' ); ?>"></td></tr>
                            <tr><th>Име (RO)</th><td><input type="text" name="name_ro" class="regular-text" value="<?php echo esc_attr( $editing['name_ro'] ?? '' ); ?>"></td></tr>
                            <tr><th>Капацитет</th><td><input type="number" name="capacity" min="1" value="<?php echo $editing['capacity'] ?? 2; ?>"></td></tr>
                            <tr><th>Цена / нощ (лв.)</th><td><input type="number" name="price" step="0.01" min="0" value="<?php echo $editing['price'] ?? 0; ?>"></td></tr>
                            <tr><th>Подредба</th><td><input type="number" name="sort_order" min="0" value="<?php echo $editing['sort_order'] ?? 0; ?>"></td></tr>
                            <tr><th>Видим</th><td><label><input type="checkbox" name="visible" <?php checked( $editing['visible'] ?? 1, 1 ); ?>> Да</label></td></tr>
                        </table>
                ...
                <div class="pino-col-table">
                    <table class="wp-list-table widefat fixed striped">
                        <thead><tr><th>ID</th><th>Име (BG)</th><th>Капацитет</th><th>Цена</th><th>Ред</th><th>Действия</th></tr></thead>
                        <tbody>
            ...
            <div class="pino-two-col">
                <div class="pino-col-form">
                    ...
                    <form method="post">
                        ...
                        <table class="form-table">
                            <tr><th>Наименование</th><td><input type="text" name="name" class="regular-text" value="<?php echo esc_attr( $editing['name'] ?? '' ); ?>" required></td></tr>
                            <tr>
                                <th>Тип стая</th>
                                <td>
                            ...
                            <tr><th>Етаж</th><td><input type="number" name="floor" value="<?php echo $editing['floor'] ?? 1; ?>"></td></tr>
                            <tr><th>Видима</th><td><label><input type="checkbox" name="visible" <?php checked( $editing['visible'] ?? 1, 1 ); ?>> Да</label></td></tr>
                        </table>
                ...
                <div class="pino-col-table">
                    <table class="wp-list-table widefat fixed striped">
                        <thead><tr><th>ID</th><th>Наименование</th><th>Тип</th><th>Етаж</th><th>Действия</th></tr></thead>
                        <tbody>
    ...
    public function page_meals() {
        ...
        <div class="wrap pino-admin">
            ...
            <div class="pino-two-col">
                <div class="pino-col-form">
                    ...
                    <form method="post">
                        ...
                        <table class="form-table">
                            ...
                            <tr><th>Име (EN)</th><td><input type="text" name="name_en" class="regular-text" value="<?php echo esc_attr( $editing['name_en'] ?? '' ); ?>"></td></tr>
                            <tr><th>Име (RO)</th><td><input type="text" name="name_ro" class="regular-text" value="<?php echo esc_attr( $editing['name_ro'] ?? '' ); ?>"></td></tr>
                            <tr><th>Описание (BG)</th><td><textarea name="desc_bg" rows="2" class="large-text"><?php echo esc_textarea( $editing['desc_bg'] ?? '' ); ?></textarea></td></tr>
                            <tr><th>Описание (EN)</th><td><textarea name="desc_en" rows="2" class="large-text"><?php echo esc_textarea( $editing['desc_en'] ?? '' ); ?></textarea></td></tr>
                            <tr><th>Описание (RO)</th><td><textarea name="desc_ro" rows="2" class="large-text"><?php echo esc_textarea( $editing['desc_ro'] ?? '' ); ?></textarea></td></tr>
                            <tr><th>Цена (лв./ден/човек)</th><td><input type="number" name="price" step="0.01" min="0" value="<?php echo $editing['price'] ?? 0; ?>"></td></tr>
                            <tr><th>Видимо</th><td><label><input type="checkbox" name="visible" <?php checked( $editing['visible'] ?? 1, 1 ); ?>> Да</label></td></tr>
                        </table>
                ...
                <div class="pino-col-table">
                    <table class="wp-list-table widefat fixed striped">
                        <thead><tr><th>ID</th><th>Име (BG)</th><th>Цена</th><th>Действия</th></tr></thead>
                        <tbody>
